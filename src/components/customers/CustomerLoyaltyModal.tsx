      ...
      <div className="space-y-5">
        ...
        {action === null && (
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 border-2 border-orange-200 text-orange-700 bg-orange-50 hover:bg-orange-100 rounded-xl py-3 text-sm font-semibold transition disabled:opacity-40 disabled:cursor-not-allowed"
            >
              <Gift size={16} />
              Tukar Poin
            </button>
        ...
        {action !== null && (
          <div className="border border-gray-100 rounded-xl p-4 space-y-3">
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">Jumlah Poin</label>
              <input
                type="number"
                min="1"
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <p className="text-sm font-semibold text-gray-700">Riwayat Poin</p>
          </div>

          {history.length === 0 ? (
            <p className="text-xs text-gray-400 text-center py-6">Belum ada riwayat poin</p>
          ) : (
                ...
                <div key={tx.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                  <div className="flex items-center gap-2">
                    {tx.type === 'EARN'
                      ...
                      : <TrendingDown size={14} className="text-orange-500 shrink-0" />}
                    <div>
                  ...
                  <div className="text-right">
                    <p className="text-xs font-semibold text-gray-600">{tx.balance_after.toLocaleString()} poin</p>
